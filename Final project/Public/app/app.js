...
var render = function() 
{
   renderTable('/unit', '#unit');
   renderTable('/startingClass', '#startingClass');
   renderTable('/weaponTypes', '#weaponTypes');
   renderTable('/promotion', '#promotion');
   renderTable('/items', '#items');
   renderTable('/unit_startingClass', '#unit_startingClass');
   renderTable('/startingClass_weaponTypes', '#startingClass_weaponTypes');
   renderTable('/startingClass_promotion', '#startingClass_promotion');
   renderTable('/unit_items', '#unit_items');
